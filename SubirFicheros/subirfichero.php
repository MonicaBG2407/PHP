...
$codigosErrorSubida= [ 
    0 => 'Subida correcta',
    1 => 'El tamaÃ±o del archivo excede el admitido por el servidor',
    2 => 'El tamaÃ±o del archivo excede el admitido por el cliente',
    ...
    8 => 'Una extensiÃ³n PHP evito la subida del archivo'
]; 
...
<body>
	<div id="formulario">
		<h2 style="color:5F00BA"><?php echo "Bienvenido ".$_REQUEST['nombre']."<br>"?></h2>
			...
			<br />
			<a href="subirfichero.html">Volver a la pÃ¡gina de subida</a>
	</div>
</body>
</html>
