...
// Enrutamiento
// RelaciÃ³n entre peticiones y funciÃ³n que la va a tratar
// VersiÃ³n sin POO no manejo de Clases ni objetos
$rutasUser = [
    ...
    if ( $_SESSION['modo'] == GESTIONUSUARIOS){
        if (isset($_GET['orden'])){
            ...
            if ( isset ($rutasUser[$_GET['orden']]) ){
                ...
                // Error no existe funciÃ³n para la ruta
